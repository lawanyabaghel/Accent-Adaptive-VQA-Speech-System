#!/bin/bash
#SBATCH --job-name=kinyarwanda
#SBATCH --output=kinyarwanda.out
#SBATCH --error=kinyarwanda.err
...
python evaluate_tts.py \
  ...
  --tts_language "en" \
  --sample_rate 24000 \
  --output_dir "/data/user_data/mkapadni/speech_project/tts_outputs_kinyarwanda" 
